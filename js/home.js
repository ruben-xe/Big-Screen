  ...
  $user.addEventListener('click', () => {
    Swal.fire({
      ...
      footer:
        ...
        <div class="social">
          <a href="https://twitter.com" target="_blank" class="social_icon"><i class="fab fa-twitter"></i></a>
          <a href="https://github.com/ruben-xe" target="_blank" class="social_icon"><i class="fab fa-github"></i></a>
        </div>`
    });
  });
